...
import { RouteController } from "@/components/route-controller"
...
export function MapSection() {
  ...
  return (
    <RouteProvider>
      {/* Map container — overflow-hidden clips to rounded shape; controls are OUTSIDE this div */}
      <motion.div
      ...
      {/* Route controls — normal flow, sits between map and search/stations */}
      <RouteController />
    </RouteProvider>
  )
}
